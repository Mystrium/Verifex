...
<table class="table table-striped table-success">
    ...
    <tbody>
        ...
        <tr>
            ...
            <form method="GET" action="{{ url('/units/delete/' . $unit->id) }}" style="display:inline">
                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm(&quot;Видалити {{$unit->title}} цех ?&quot;)">
